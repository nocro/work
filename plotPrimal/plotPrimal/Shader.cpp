...
bool Shader::charger()
{
    ...
    glBindAttribLocation(m_programID, 0, "in_Vertex");//en gros les element envoyer avec le parametre 0 seron receptionné dans la variable "in_Vertex" du shader
    glBindAttribLocation(m_programID, 1, "in_normal");
    glBindAttribLocation(m_programID, 2, "in_TexCoord0");
	/*ajoue de in color 19/05/2018*/
	glBindAttribLocation(m_programID, 3, "in_Color");// le probleme c'est qu'il veux 
...
void Shader::envoyerMat4(std::string nom, glm::mat4 matrice)const 
{
